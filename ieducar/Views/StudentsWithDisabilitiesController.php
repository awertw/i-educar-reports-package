...
class StudentsWithDisabilitiesController extends Portabilis_Controller_ReportCoreController
{
    ...
    public function form()
    {
        ...
        $this->inputsHelper()->dynamic(['deficiencia'], ['required' => false]);        
    ...
    public function beforeValidation()
    {
        ...
        $this->report->addArg('disabilities', (int) $this->getRequest()->deficiencia_id);
        //dd($this->getRequest()->deficiencia_id);
